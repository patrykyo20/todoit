...
export function AddEventDialog({
  ...
  useEffect(() => {
    if (isOpen) {
      const newStartDate = initialDate || initialStartTime || new Date();
      const newEndDate = initialDate || initialEndTime || new Date();
      const newStartTime = initialStartTime
        ? format(initialStartTime, "HH:mm")
        : "09:00";
  ...
  }, [isOpen, initialDate, initialStartTime, initialEndTime, form]);
