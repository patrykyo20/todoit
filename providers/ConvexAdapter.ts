...
export const ConvexAdapter: Adapter = {
  ...
  async linkAccount(account: Account) {
    console.log("🔗 ConvexAdapter.linkAccount called with:", {
    ...
    const result = await callMutation(api.authAdopter.linkAccount, { account });
    console.log("✅ ConvexAdapter.linkAccount completed, result:", result?._id);
    return result;
  },
